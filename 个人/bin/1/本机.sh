...
FILENAME1="E:/vsms/documents/mysql/chart/proc_chart_ability_allcompetewin.sql"
FILENAME2="E:/vsms/documents/mysql/chart/proc_chart_ability_allstagewin.sql"
FILENAME3="E:/vsms/documents/mysql/chart/proc_chart_ability_competewin.sql"
FILENAME4="E:/vsms/documents/mysql/chart/proc_chart_ability_optanalysiswin.sql"
FILENAME5="E:/vsms/documents/mysql/chart/proc_chart_ability_optboost.sql"
FILENAME6="E:/vsms/documents/mysql/chart/proc_chart_ability_optinvalid.sql"
FILENAME7="E:/vsms/documents/mysql/chart/proc_chart_ability_optreceivingperiod.sql"
FILENAME8="E:/vsms/documents/mysql/chart/proc_chart_ability_orderdistribution.sql"
FILENAME9="E:/vsms/documents/mysql/chart/proc_chart_ability_orderreceiving.sql"
FILENAME10="E:/vsms/documents/mysql/chart/proc_chart_ability_orderreceivingmoney.sql"

FILENAME31="E:/vsms/documents/mysql/chart/proc_chart_optanalysis_industry.sql"
FILENAME32="E:/vsms/documents/mysql/chart/proc_chart_optanalysis_product.sql"
FILENAME33="E:/vsms/documents/mysql/chart/proc_chart_optanalysis_region.sql"
FILENAME34="E:/vsms/documents/mysql/chart/proc_chart_optsize_allstagewin.sql"
FILENAME35="E:/vsms/documents/mysql/chart/proc_chart_optsize_chart.sql"
FILENAME36="E:/vsms/documents/mysql/chart/proc_chart_optsize_grid.sql"
FILENAME37="E:/vsms/documents/mysql/chart/proc_chart_optsize_shape.sql"
FILENAME38="E:/vsms/documents/mysql/chart/proc_chart_optsize_target.sql"
FILENAME39="E:/vsms/documents/mysql/chart/proc_chart_optsizemain_chart.sql"
FILENAME40="E:/vsms/documents/mysql/chart/proc_chart_opttype_chart.sql"

FILENAME11="E:/vsms/documents/mysql/chart/proc_chart_productanalysis_industry.sql"
FILENAME12="E:/vsms/documents/mysql/chart/proc_chart_productanalysis_productbubble.sql"
FILENAME13="E:/vsms/documents/mysql/chart/proc_chart_productanalysis_productdistribution.sql"
FILENAME14="E:/vsms/documents/mysql/chart/proc_chart_productanalysis_region.sql"
FILENAME15="E:/vsms/documents/mysql/chart/proc_chart_productanalysis_toptencustomer.sql"
FILENAME16="E:/vsms/documents/mysql/chart/proc_chart_productanalysis_toptenopt.sql"
FILENAME17="E:/vsms/documents/mysql/chart/proc_chart_productanalysis_toptenproduct.sql"

FILENAME21="E:/vsms/documents/mysql/import/proc_import_batchCheck.sql"
FILENAME22="E:/vsms/documents/mysql/import/proc_import_check.sql"
FILENAME23="E:/vsms/documents/mysql/import/proc_import_cleanSystem.sql"
FILENAME24="E:/vsms/documents/mysql/import/proc_import_copy.sql"
FILENAME25="E:/vsms/documents/mysql/import/proc_import_createMemoryTable.sql"
FILENAME26="E:/vsms/documents/mysql/import/proc_import_dropMemoryTable.sql"
FILENAME27="E:/vsms/documents/mysql/import/proc_import_financialData_check.sql"
FILENAME28="E:/vsms/documents/mysql/import/proc_import_financialData_createMemoryTable.sql"
FILENAME29="E:/vsms/documents/mysql/import/proc_import_updateCN.sql"
FILENAME30="E:/vsms/documents/mysql/import/proc_import_updateEN.sql"




# FILENAME51="E:/vsms/documents/mysql/stat/proc_stat_ability_accumulation.sql"
# FILENAME41="E:/vsms/documents/mysql/stat/proc_stat_ability_allcompetewin.sql"
# FILENAME42="E:/vsms/documents/mysql/stat/proc_stat_ability_allstagewin.sql"
# FILENAME53="E:/vsms/documents/mysql/stat/proc_stat_ability_averaging.sql"
# FILENAME43="E:/vsms/documents/mysql/stat/proc_stat_ability_competewin.sql"
# FILENAME44="E:/vsms/documents/mysql/stat/proc_stat_ability_optanalysiswin.sql"
# FILENAME45="E:/vsms/documents/mysql/stat/proc_stat_ability_optboost.sql"
# FILENAME46="E:/vsms/documents/mysql/stat/proc_stat_ability_optinvalid.sql"
# FILENAME47="E:/vsms/documents/mysql/stat/proc_stat_ability_optreceivingperiod.sql"
# FILENAME48="E:/vsms/documents/mysql/stat/proc_stat_ability_orderdistribution.sql"
# FILENAME49="E:/vsms/documents/mysql/stat/proc_stat_ability_orderreceiving.sql"
# FILENAME50="E:/vsms/documents/mysql/stat/proc_stat_ability_orderreceivingmoney.sql"

FILENAME52="E:/vsms/documents/mysql/stat/proc_stat_stat.sql"
...
FILENAME81="E:/vsms/documents/mysql/stat/faranchise/proc_faranchise_stat_ability_allcompetewin.sql"
FILENAME82="E:/vsms/documents/mysql/stat/faranchise/proc_faranchise_stat_ability_allstagewin.sql"
FILENAME83="E:/vsms/documents/mysql/stat/faranchise/proc_faranchise_stat_ability_competewin.sql"
FILENAME84="E:/vsms/documents/mysql/stat/faranchise/proc_faranchise_stat_ability_optanalysiswin.sql"
FILENAME85="E:/vsms/documents/mysql/stat/faranchise/proc_faranchise_stat_ability_optboost.sql"
FILENAME86="E:/vsms/documents/mysql/stat/faranchise/proc_faranchise_stat_ability_optinvalid.sql"
FILENAME87="E:/vsms/documents/mysql/stat/faranchise/proc_faranchise_stat_ability_optreceivingperiod.sql"
FILENAME88="E:/vsms/documents/mysql/stat/faranchise/proc_faranchise_stat_ability_orderdistribution.sql"
FILENAME89="E:/vsms/documents/mysql/stat/faranchise/proc_faranchise_stat_ability_orderreceiving.sql"
FILENAME90="E:/vsms/documents/mysql/stat/faranchise/proc_faranchise_stat_ability_orderreceivingmoney.sql"
...
mysql -h${HOSTNAME}  -P${PORT}  -u${USERNAME} -p${PASSWORD} --default-character-set=utf8 ${DBNAME}  <  ${FILENAME85}
mysql -h${HOSTNAME}  -P${PORT}  -u${USERNAME} -p${PASSWORD} --default-character-set=utf8 ${DBNAME}  <  ${FILENAME86}
mysql -h${HOSTNAME}  -P${PORT}  -u${USERNAME} -p${PASSWORD} --default-character-set=utf8 ${DBNAME}  <  ${FILENAME87}
mysql -h${HOSTNAME}  -P${PORT}  -u${USERNAME} -p${PASSWORD} --default-character-set=utf8 ${DBNAME}  <  ${FILENAME88}
mysql -h${HOSTNAME}  -P${PORT}  -u${USERNAME} -p${PASSWORD} --default-character-set=utf8 ${DBNAME}  <  ${FILENAME89}
mysql -h${HOSTNAME}  -P${PORT}  -u${USERNAME} -p${PASSWORD} --default-character-set=utf8 ${DBNAME}  <  ${FILENAME90}
